...
import com.example.talkpoint.Adapter.CommentAdapter;
...
import com.example.talkpoint.databinding.ActivityCommentBinding;
...
public class CommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //this is created because we want data from the post
        ...
        //this is created because we want data from user like name
        database.getReference()
                .child("Users")
        ...
        // foe set comment in the recyclerView
                ...
                database.getReference()
                        ...
                        .setValue(comment).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void unused) {
                                // for count the number of comment
                                database.getReference()
                                        .child("posts")
                                        .child(postId)
