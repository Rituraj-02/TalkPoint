...
//    }
//
//    public DasboardModel(int profile, int postImage, int save, String name, String like, String about, String share, String comment) {
//        this.profile = profile;
//        this.postImage = postImage;
//        this.save = save;
//        this.name = name;
...
//    }
//
//    String name,like,about,share,comment;
